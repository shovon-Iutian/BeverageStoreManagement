	...
	<form action="/frontend/createorder" method="post" onsubmit="return validate(this);">
		...
		<table border="1" class="table table-striped table-responsive" >
			...
			<tr>
				...
				<td>
					<div class="col-xs"><input type="checkbox" name="selectedBeverage" value="<%=beverage.getId()%>" ></div>
				</td>
				<td>
					<div class="col-xs"><input type="number"  name="<%=beverage.getId()%>_quantity" min="0" max="<%=beverage.getQuantity()%>" value="0" ></div>
				</td>
